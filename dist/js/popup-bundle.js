...
exports.deleteLink = exports.saveLink = exports.findAllLinks = exports.findLink = void 0;
const utils_1 = __webpack_require__(/*! ./utils */ "./src/common/utils.ts");
let _STORE;
const STORE_KEY = '__ez-link-extn-store__';
const chromeStorageGet = () => __awaiter(void 0, void 0, void 0, function* () {
...
const chromeStorageSet = (settings) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
...
const saveStore = (settings) => __awaiter(void 0, void 0, void 0, function* () {
    yield chromeStorageSet(settings);
    _STORE = Object.assign(Object.assign({}, _STORE), settings);
});
const loadStore = () => __awaiter(void 0, void 0, void 0, function* () {
    if (_STORE === undefined) {
        const items = yield chromeStorageGet();
        _STORE = Object.assign({}, items[STORE_KEY]);
    }
    return Object.assign({}, _STORE);
});
const withStore = (callback) => __awaiter(void 0, void 0, void 0, function* () {
    const clonedStore = Object.assign({}, _STORE);
    callback(clonedStore);
    yield saveStore(clonedStore);
    _STORE = clonedStore;
});
const findLink = (id) => {
...
const findAllLinks = () => __awaiter(void 0, void 0, void 0, function* () {
    const settings = yield loadStore();
    const entries = [];
...
const saveLink = (item) => __awaiter(void 0, void 0, void 0, function* () {
    const id = (0, utils_1.defaultIfEmpty)(item.id, `${new Date().getTime()}`);
    yield withStore((clonedStore) => clonedStore[id] = Object.assign(Object.assign({}, item), { id: id }));
    return id;
});
exports.saveLink = saveLink;
const deleteLink = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const entry = (0, exports.findLink)(id);
    yield withStore((clonedStore) => delete clonedStore[entry.id]);
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.toBoolean = exports.ifExists = exports.defaultIfEmpty = exports.isEmpty = void 0;
const isEmpty = (obj) => (obj === undefined || obj === null || (typeof obj === 'string' && obj.trim() === ''));
exports.isEmpty = isEmpty;
const defaultIfEmpty = (obj, defaultValue) => (0, exports.isEmpty)(obj) ? defaultValue : obj;
exports.defaultIfEmpty = defaultIfEmpty;
const ifExists = (value, nonNullCallback) => value ? nonNullCallback(value) : value;
exports.ifExists = ifExists;
const toBoolean = (val) => val === 'true' ? true : false;
...
const db = __importStar(__webpack_require__(/*! ./common/local-store */ "./src/common/local-store.ts"));
...
let AppComponent = class AppComponent extends lit_1.LitElement {
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            const links = yield db.findAllLinks();
        ...
        <ul id="available-links">
            ${hasLinks && links.map(l => (0, lit_1.html) `<app-link link=${l}></app-link>`)}
        </ul>
        ${this.linkForm && (0, lit_1.html) `<app-link-form></app-link-form>`}
        `;
        });
    }
};
...
exports.AppComponent = AppComponent = __decorate([
    (0, decorators_js_1.customElement)("app-root")
], AppComponent);
/* const init = async () => {
